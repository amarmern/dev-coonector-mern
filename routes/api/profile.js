...
router.post(
  ...
  [
    ...
    [
      ...
      check('skills', 'Skills is reuired').not().isEmpty(),
    ],
  ],
  async (req, res) => {
...
//@desc Add profile experince in User profile
//@access Private
...
router.put(
  ...
  [
    ...
    [
      ...
      check('company', 'Company is reuired').not().isEmpty(),
...
router.put(
  ...
  [
    ...
    [
      ...
      check('fieldofstudy', 'Field of study is reuired').not().isEmpty(),
      check('from', 'From Date is reuired').not().isEmpty(),
    ],
  ],
  async (req, res) => {
